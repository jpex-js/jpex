...
function getDecorators(parentClass, name){
  var d = [];
...
function resolveDependencies(theClass, obj, namedParameters, globalOptions, stack){
  ...
  function dothework(name, localOptions){
    ...
    var decorators = theClass._getDecorators(name);
    ...
    if (decorators.length){
      decorators.forEach(function(d){
        var args = resolveDependencies(theClass, d, namedParameters, localOptions);
        result = d.fn.apply(result, args);
      });
    }
